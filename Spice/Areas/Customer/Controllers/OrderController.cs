...
namespace Spice.Areas.Customer.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public async Task<IActionResult> ManageOrder(int productPage = 1)
        {
            ...
            List<OrderDetailsViewModel> OrderHeaderVM = new List<OrderDetailsViewModel>();
            ...
            foreach (OrderHeader item in OrderHeaderList)
            {
                ...
                OrderHeaderVM.Add(individual);
            }

            return View(OrderHeaderVM.OrderBy(o => o.OrderHeader.PickUpTime).ToList());
            ...
            if (searchName != null || searchEmail != null || searchPhone != null)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            OrderHeaderList = await _db.OrderHeader.Include(o => o.ApplicationUser)
                                                        .Where(u => u.PickupPhoneNumber.Contains(searchPhone))
                                                        .OrderByDescending(o => o.OrderDate).ToListAsync();
                        }
                    }
                }
        ...
        public async Task<IActionResult> OrderPickupPost(int OrderId)
        {
            ...
            await _db.SaveChangesAsync();
            await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == orderHeader.userId).FirstOrDefault().Email, "Spice - Order completed " + orderHeader.Id.ToString(), "Order is available for pickup.");

...
namespace Spice.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            if (claim !=null)
            {
                //claim will be none if user has not logged in
        ...
        public async Task<IActionResult> Details(ShoppingCart CartObject)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (cartFromDb == null)
                {
                    //user has not added this menu item in their shipping cart before
                    _db.ShoppingCart.Add(CartObject);
                }
                else
                {
                    //update count because menu item already exists in shopping cart
